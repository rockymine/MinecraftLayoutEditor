...
public class RegionRenderer : IRenderable
{
    ...
    {
        var paint = context.Cache.GetPaint(SKColors.Purple, SKPaintStyle.Stroke, 1f, context.Scale);
    ...
    {
        var paint = context.Cache.GetPaint(SKColors.Blue, SKPaintStyle.Stroke, 1f, context.Scale);
    ...
    {
        var paint = context.Cache.GetPaint(SKColors.Blue, SKPaintStyle.Fill, 0.5f, context.Scale);
    ...
    {
        var paint = context.Cache.GetPaint(SKColors.Blue, SKPaintStyle.Fill, 1f, context.Scale);
