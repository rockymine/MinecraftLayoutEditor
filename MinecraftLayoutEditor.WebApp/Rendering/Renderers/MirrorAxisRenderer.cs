...
public class MirrorAxisRenderer : IRenderable
{
    public void Render(RenderContext context)
    {
        ...
        var mirrorLinePaint = context.Cache.GetPaint(mirrorLineStyle.StrokeStyle, SKPaintStyle.Stroke, mirrorLineStyle.LineWidth, context.Scale);
        ...
        if (context.Map.Symmetry.RotationDeg == 180)
        {
            ...
            var mirrorPointPaint = context.Cache.GetPaint(mirrorPointStyle.FillStyle, SKPaintStyle.Fill, mirrorPointStyle.LineWidth, context.Scale);
